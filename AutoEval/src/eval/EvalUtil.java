...
public final class EvalUtil {
	...
	public static void creatLogDir(String LogsDir) {
		...
		if (logsFDir.mkdirs()) {
			System.out.println("Directory %s has been created." + logsFDir.getAbsolutePath());

		} else if (logsFDir.isDirectory()) {
			System.out.println("Directory %s has already been created." + logsFDir.getAbsolutePath());

		} else {
			System.out.println("Directory %s could not be created." + logsFDir.getAbsolutePath());
		}
	}
